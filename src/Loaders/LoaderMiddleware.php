...
use Intoye\HebatFactory\Loader;
use Intoy\HebatMiddleware\RouteInputMiddleware;
use Intoy\HebatMiddleware\GuardMiddleware;
...
class LoaderMiddleware extends Loader
{
    ...
    {        
        ...
        foreach($all_middleware as $mid)
        {
            ...
            elseif($mid===RouteInputMiddleware::class)
            {
                $alias="route.input.middleware.web";
                $guard=$this->createInputMiddlewareResolvable($mid);
            }       
